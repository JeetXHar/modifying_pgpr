...
PATH_PATTERN = {
    ...
    "ML1M_extend":{
        0: ((WATCHED, USER), (WATCHED, PRODUCT)),
        2: ((CINEMATOGRAPHY_BY, CINEMATOGRAPHER), (CINEMATOGRAPHY_BY, PRODUCT)),
        3: ((PRODUCED_BY_COMPANY, PRODUCTION_COMPANY), (PRODUCED_BY_COMPANY, PRODUCT)),
        4: ((COMPOSED_BY, COMPOSER), (COMPOSED_BY, PRODUCT)),
        5: ((BELONG_TO, CATEGORY), (BELONG_TO, PRODUCT)),
        7: ((STARRING, ACTOR), (STARRING, PRODUCT)),
        8: ((EDITED_BY, EDITOR), (EDITED_BY, PRODUCT)),
        9: ((PRODUCED_BY_PRODUCER, PRODUCER), (PRODUCED_BY_PRODUCER, PRODUCT)),
        10: ((WROTE_BY, WRITTER), (WROTE_BY, PRODUCT)),
        11: ((DIRECTED_BY, DIRECTOR), (DIRECTED_BY, PRODUCT)),
        12: ((PRODUCED_IN, COUNTRY), (PRODUCED_IN, PRODUCT)),
    },
